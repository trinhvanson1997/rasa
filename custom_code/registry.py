...
from rasa_nlu.classifiers.embedding_intent_classifier import EmbeddingIntentClassifier
...
from rasa_nlu.tokenizer import ViTokenizer
from rasa_nlu.featurizer import TfidfFeaturizer
